...
export default function SupportStaffLoginScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { data } = await api.post("/auth/login", {
        ...
        phone: identifier,
        password,
        portal: AUTH_PORTAL_SUPPORT_STAFF,
      });
      const { user, accessToken, refreshToken, mustChangePassword } = data;
      if (!isSupportStaffRole(user.role)) {
        setError("This portal is for accountant, cleaning staff, and other school roles only.");
        return;
      }
      ...
      >
        ...
        >
          <View style={styles.card}>
            ...
            <Text style={styles.title}>Other staff</Text>
